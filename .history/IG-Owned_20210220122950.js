...
(function () {
  ...
  function check () {
    const allGames = GM_setValue('IG-Owned')?.games || []
  ...
  async function syncLib (notice = true, update = false) {
    let allGames = GM_setValue('IG-Owned')?.games || []
  ...
  GM_registerMenuCommand('同步游戏库', syncLib)
  syncLib(false, false)
})()
