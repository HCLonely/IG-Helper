...
(function () {
  ...
  function addButton () {
    for (const el of $('a[href^="https://freebies.indiegala.com/"]:not(".ig-helper")')) {
      ...
      const addToLibraryButton = $(`<a class="add-to-library" href="javascript:void(0)" data-href="${href}" target="_self">入库</a>`)
      $this.after(addToLibraryButton).addClass('ig-helper').next().click(async function () {
        Swal.fire({
          title: '正在获取入库链接...',
          icon: 'info'
        })
